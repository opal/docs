...
<body>     
    <div class="banner">
        ...
        <ul class="files">
            <li>opal/stdlib/nodejs/node_modules/glob/node_modules/inflight/node_modules/wrappy/test/basic.js</li>
...
<p>var test = require(&#39;tap&#39;).test var wrappy =
require(&#39;../wrappy.js&#39;)</p>

<p>test(&#39;basic&#39;, function (t) {</p>

<pre><code>function onceifier (cb) {
  var called = false
  return function () {
    if (called) return
    called = true
