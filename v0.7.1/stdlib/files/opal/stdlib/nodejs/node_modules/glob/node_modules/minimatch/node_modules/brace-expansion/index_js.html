...
<body>     
    <div class="banner">
        ...
        <ul class="files">
            <li>opal/stdlib/nodejs/node_modules/glob/node_modules/minimatch/node_modules/brace-expansion/index.js</li>
...
<p>var concatMap = require(&#39;concat-map&#39;); var balanced =
...
href="test/cases_txt.html">cases</a> // where we have nested braced
sections, which should be // treated as individual members, like
{a,{b,c},d} function parseCommaParts(str) {</p>
...
return expand(escapeBraces(str), true).map(unescapeBraces);</code></pre>
